...
export default async function ConsoleLayout({
  ...
  return (
    <div className="bg-primary/15 relative flex h-screen w-full items-center justify-center bg-[url(/images/green-background-light.jpg)] bg-cover bg-no-repeat md:p-6">
