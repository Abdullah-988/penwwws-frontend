...
export default function GoogleOAuthBtn() {
  const URL = `https://accounts.google.com/o/oauth2/auth?redirect_uri=https://www.penwwws.com/auth/session/callback&response_type=token&client_id=${process.env.GOOGLE_CLIENT_ID}&scope=openid%20email%20profile`;
  return (
